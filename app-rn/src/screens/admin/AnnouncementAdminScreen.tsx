      ...
      >
        ...
        <Card>
          <View style={{ padding: 14 }}>
            ...
            {field(t('admin.ann.imageUrl'), imageUrl, setImageUrl, 'https://…/banner.jpg', {
              keyboardType: 'url',
            })}
            ...
            {field(t('admin.ann.startsAt'), startsAt, setStartsAt, '2026-06-10T00:00:00Z')}
            {field(t('admin.ann.endsAt'), endsAt, setEndsAt, '2026-06-20T00:00:00Z')}
